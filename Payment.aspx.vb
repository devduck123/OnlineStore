...
Public Class Payment
    ...
    Private Sub btnAPI_Click(sender As Object, e As EventArgs) Handles btnAPI.Click
        ...
        post_values.Add("x_login", "6nD2QAqJ5x6A") ' your login ID
        post_values.Add("x_tran_key", "9df962v75JEWC9sM") ' your transaction key
        ...
        ' the keys and values are encoded in
        ' key-value tuples separated by '&',
        ...
        ' display Authorization Code and Transaction ID in the two label controls by response_array(x)

        lblAuthorizationCode.Text = response_array(4)
